...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>FINANCIAL REPORT | COEC - Community Outreach for Educational Change.html</title>
...
<div class="page-header">
        ...
        <?php
                               ...
                               $blog = new run_query( "select * from content where type ='FIN_REPORT' and status = '1'" );
                               if( $blog->num_rows >= 1){
