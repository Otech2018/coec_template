...
?>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">EDIT PROGRESS REPORT </h1>
                    ...
                    <div class="col-md-8">
                        <form method='POST' enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" required placeholder="eg 2023"  value="<?=$data1?>" name="data1" type="text">
                            </div> <br>
            

                            <div class="form-group">
                                <label>Enter Date</label>
                                <input class="form-control" required placeholder="eg Sept 21" value="<?=$data2?>" name="data2" type="text">
                            </div> <br>
